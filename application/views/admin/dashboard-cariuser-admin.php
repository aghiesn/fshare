                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-1 offset-2 offset-md-7">
                                    <a class="btn text-black rounded-3" href="<?php echo base_url('admin/home/allaccount'); ?>" style="text-align: center; background-color: #BFE3DF;"><i class="mt-2">Kembali</i></a>
                                </div>
                            </div>
                            <div class="row">
