...
bila user mengetikan keyword akan otomatis diperluas, kemudian keywordnya akan diarahkan ke 
controller auth bagian hasil_pencarian -->
<div class="container">
  <nav class="navbar mt-3" style="padding: 0px 0px;" data-aos="fade-down" data-aos-offset="0">
      ...
      <div id="search-form">
        <form action="<?php echo site_url('auth/hasil_pencarian'); ?>" method="post">
...
<script>
  function expandSearchBar() {
    ...
    // Menentukan Lebar awal
    var initialWidth = 150;

    // Menentukan penambahan lebar, apabila diketik
